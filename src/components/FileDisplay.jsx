...
export default function FileDisplay(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-full max-w-prose mx-auto'>
            <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl'>Your <span className='text-red-300 bold'>File</span></h1>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <button onClick={handleFormSubmission} className='specialBtn  px-3 p-2 rounded-lg text-red-300 flex items-center gap-2 font-medium '>
                    <p>Transcribe</p>
