    ...
    return (
        <div className='flex items-center flex-1 flex-col justify-center gap-10 md:gap-14 text-center pb-24 p-4'>
            <div className='flex flex-col gap-2 sm:gap-4'>
                ...
                <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl'><span className='text-red-300 bold'>Transcribing</span></h1>
                <p>{!downloading ? 'beggining download...' : 'download is finished!'}</p>
            </div>
